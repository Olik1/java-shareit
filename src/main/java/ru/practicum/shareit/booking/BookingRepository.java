...
//    List<Booking> findByItemOwner_IdAndEndsIsBefore(Long bookerId, LocalDateTime ends, Sort sort);
List<Booking> findByItemOwnerIdAndEndsIsBefore(Long bookerId, LocalDateTime ends, Sort sort);

//    List<Booking> findByItemOwner_IdAndStartsIsAfter(Long bookerId, LocalDateTime starts, Sort sort);
    List<Booking> findByItemOwnerIdAndStartsIsAfter(Long bookerId, LocalDateTime starts, Sort sort);

//    List<Booking> findByItemOwner_IdAndStatus(Long bookerId, Status status, Sort sort);
    List<Booking> findByItemOwnerIdAndStatus(Long bookerId, Status status, Sort sort);

//    List<Booking> findByItemOwner_IdAndStartsIsBeforeAndEndsIsAfter(Long bookerId, LocalDateTime starts,
//                                                                    LocalDateTime ends, Sort sort);
